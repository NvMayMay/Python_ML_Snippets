...
# Load the dataset, looking at California housing data to predict house prices
data = fetch_california_housing()
X, y = data.data, data.target
# Describe the dataset by uncommenting the line below
#print(data.DESCR)
...
# Plot actual vs predicted values, delete hash in below section to print
...
# Plot histogram of residual errors, delete hash in below section to print
...
# Plot residuals by median house value, delete hash in below section to print
...
# Plot feature importance, delete hash in below section to print
# Feature importances
