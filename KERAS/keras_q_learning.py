...
#disables oneDNN optimizations and forces CPU usage
import os 
...
def build_model(state_size, action_size): 
    ...
    model.add(Dense(24, activation='relu')) 
    model.add(Dense(action_size, activation='linear')) # Output layer with linear activation for continuous Q-values
...
# Experiemnt with different network architectures, learning rates, and exploration strategies
import gym
import numpy as np
...
env.close()
# implement adaptive learning rate and experience replay
