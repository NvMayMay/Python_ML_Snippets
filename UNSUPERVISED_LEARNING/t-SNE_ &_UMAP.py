...
# python3 -m pip install numpy pandas matplotlib scikit-learn plotly umap-learn
...
# Create interactive 3D scatter plot, delete hash in below section to print
...
# Standardize the data before applying dimensionality reduction techniques
scaler = StandardScaler()
X_scaled = scaler.fit_transform(X)

#Apply t-SNE to reduce the 3D data to 2D, delete hash in below section to print
...
# Plot the 2D UMAP projection result, delete hash in below section to print
fig = plt.figure(figsize=(8, 6))
ax = fig.add_subplot(111)
...
# Apply PCA to reduce the dimensionality to 2D and compare with t-SNE and UMAP
